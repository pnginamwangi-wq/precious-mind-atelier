...
export const luxury = {
  ...
  eyebrow: "font-numeric text-xs uppercase tracking-[0.32em] text-gold",
  eyebrowMuted: "font-numeric text-xs uppercase tracking-[0.28em] text-platinum",
  bodyMuted: "text-[17px] font-normal leading-[1.7] text-platinum",
  bodySmall: "text-sm font-normal tracking-wide text-platinum",
  hairline:
