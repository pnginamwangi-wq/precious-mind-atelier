    ...
    <div className={cn(align === "right" && "md:text-right", className)}>
      ...
      {href ? (
        <div className="mt-8">
          <a
            href={href}
            className="group inline-flex items-center gap-3 text-xs font-normal uppercase tracking-[0.28em] text-ivory outline-none transition-colors hover:text-champagne focus-visible:text-champagne focus-visible:ring-1 focus-visible:ring-gold focus-visible:ring-offset-4 focus-visible:ring-offset-obsidian"
          >
            {cta}
...
export function Figure({ src, alt, aspect = "square", caption, className }: FigureProps) {
  return (
    <figure className={cn("group", className)}>
      ...
      {caption ? (
        <figcaption className={cn("mt-4 text-sm font-normal tracking-wide text-platinum")}>
          {caption}
        </figcaption>
      ) : null}
    </figure>
      ...
      {(attribution || role) && (
        <footer className={cn("mt-8 flex items-center gap-4", align === "center" && "justify-center")}>
          ...
          <div>
            ...
            {role ? (
              <div className="mt-1 text-[13px] font-normal tracking-wide text-platinum">
                {role}
              </div>
            ) : null}
          </div>
