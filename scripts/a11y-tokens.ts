...
const pairs: Pair[] = [
  ...
  { where: "Muted eyebrow: platinum/50 on obsidian", fg: mixOver(platinum, obsidian, 0.5), bg: obsidian },
  ...
  { where: "Mentor 'Session 04' label: platinum/40 on charcoal", fg: mixOver(platinum, charcoal, 0.4), bg: charcoal },
