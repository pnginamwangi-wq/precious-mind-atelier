      ...
      {status === "ok" ? (
        ...
        <form onSubmit={onSubmit} className={cn("mt-6 flex flex-col gap-3 sm:flex-row sm:items-stretch")}>
          ...
          <input
            ...
            className="min-w-0 flex-1 border border-white/15 bg-transparent px-4 py-3 font-light text-ivory placeholder:text-platinum/40 outline-none focus:border-gold focus:ring-1 focus:ring-gold"
          />
